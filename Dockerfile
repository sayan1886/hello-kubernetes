...
LABEL org.opencontainers.image.title="Hello Kubernetes!" \
      ...
      org.opencontainers.image.authors="Sayan Chatterjee" \
      org.opencontainers.image.url="https://hub.docker.com/repository/docker/sayan1886/hello-kubernetes/" \
      ...
      org.opencontainers.image.source="https://github.com/sayan1886/hello-kubernetes.git" \
      org.opencontainers.image.revision=$IMAGE_SOURCE_REVISION 

# Create app directory
RUN mkdir -p /usr/src/app
RUN useradd user && echo 'user:docker' | chpasswd
RUN echo "user ALL=(ALL) NOPASSWD: ALL" >> /etc/sudoers
RUN chown user -R /usr/src
